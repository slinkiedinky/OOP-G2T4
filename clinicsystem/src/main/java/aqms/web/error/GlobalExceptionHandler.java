 ...
 *
 * Centralized exception handling for REST controllers. Converts common exceptions into JSON
...
public class GlobalExceptionHandler {
  ...
  public Map<String, Object> generalException(Exception ex) {
    ...
    if (ex.getMessage() != null
        && ex.getMessage().contains("column")
        && ex.getMessage().contains("does not exist")) {
      message =
          "Database schema mismatch. Please restart the backend to apply migrations. Error: "
              + ex.getMessage();
    }
