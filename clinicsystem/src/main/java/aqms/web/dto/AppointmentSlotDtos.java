 ...
 * AppointmentSlotDtos
 *
 * DTOs for appointment slot management endpoints: generating slots, creating custom slots, and
 * responses returned to the UI.
 */
public class AppointmentSlotDtos {
  ...
  public record AssignDoctorToSlotRequest(Long doctorId) {}
