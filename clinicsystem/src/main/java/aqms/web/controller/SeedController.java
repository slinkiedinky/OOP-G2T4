 ...
 * SeedController
 *
 * Temporary endpoints used during development to seed test data into the database (appointment
 * slots, test users). These endpoints are intended for local/testing use only and should be removed
...
public class SeedController {
  ...
  public String seedAppointmentSlots() {
    ...
    Clinic clinic =
        clinicRepo.findById(22L).orElseThrow(() -> new RuntimeException("Clinic 22 not found"));
  ...
  public String resetAdminPassword(
      @RequestParam(defaultValue = "hy5411@gmail.com") String email,
