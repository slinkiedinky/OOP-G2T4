...
public class AppointmentSlotManagementController {
  ...
  public ResponseEntity<List<AppointmentSlotDtos.SlotResponse>> generateSlotsForDate(
      @RequestBody AppointmentSlotDtos.GenerateSlotsRequest request) {
    try {
      ...
      log.info(
          "  clinicId: {} (type: {})",
          request.clinicId(),
          request.clinicId() != null ? request.clinicId().getClass().getSimpleName() : "null");
      log.info(
          "  date: {} (type: {})",
          request.date(),
          request.date() != null ? request.date().getClass().getSimpleName() : "null");
      log.info(
          "  openTime: {} (type: {})",
          request.openTime(),
          request.openTime() != null ? request.openTime().getClass().getSimpleName() : "null");
      log.info(
          "  closeTime: {} (type: {})",
          request.closeTime(),
          request.closeTime() != null ? request.closeTime().getClass().getSimpleName() : "null");
      log.info(
          "  interval: {} (type: {})",
          request.interval(),
          request.interval() != null ? request.interval().getClass().getSimpleName() : "null");
      log.info(
          "  slotDuration: {} (type: {})",
          request.slotDuration(),
          request.slotDuration() != null
              ? request.slotDuration().getClass().getSimpleName()
              : "null");
      ...
      log.info(
          "Generating slots: clinic={}, date={}, hours={}-{}, interval={}min, duration={}min",
          request.clinicId(),
          request.date(),
          request.openTime(),
          request.closeTime(),
      ...
      var responses = slots.stream().map(this::toSlotResponse).toList();
  ...
  public ResponseEntity<List<AppointmentSlotDtos.SlotResponse>> generateDailySlots(
    ...
    try {
      ...
      for (AppointmentSlotDtos.SessionTime session : request.sessions()) {
        ...
        var sessionResponses = sessionSlots.stream().map(this::toSlotResponse).toList();

        allSlots.addAll(sessionResponses);
        log.info(
            "Generated {} slots for session {} - {}",
            sessionResponses.size(),
            session.openTime(),
            session.closeTime());
      }
  ...
  public ResponseEntity<AppointmentSlotDtos.SlotResponse> createCustomSlot(
      @RequestBody AppointmentSlotDtos.CreateCustomSlotRequest request) {
    var slot =
        slotService.createCustomSlot(
            request.clinicId(), request.doctorId(), request.startTime(), request.endTime());
  ...
  public ResponseEntity<List<AppointmentSlotDtos.SlotResponse>> getSlotsByInterval(
      @RequestParam Long clinicId, @RequestParam Integer intervalMinutes) {
  ...
  public ResponseEntity<Void> updateClinicInterval(
      @RequestBody AppointmentSlotDtos.UpdateIntervalRequest request) {
  ...
  public ResponseEntity<List<AppointmentSlotDtos.SlotResponse>> getSlotsByClinicAndDate(
    ...
    try {
      ...
      log.error(
          "Failed to fetch slots for clinic {} between {} and {}",
          clinicId,
          startTime,
          endTime,
          ex);
  ...
  public ResponseEntity<AppointmentSlotDtos.SlotResponse> assignDoctorToSlot(
    ...
    try {
      ...
      var slot =
          slotService.assignDoctorToSlot(slotId, request != null ? request.doctorId() : null);
  ...
  public ResponseEntity<List<String>> checkExistingSlots(
      @RequestParam Long clinicId, @RequestParam String startDate, @RequestParam String endDate) {
    try {
      log.info(
          "Checking for existing slots: clinic={}, start={}, end={}", clinicId, startDate, endDate);
  ...
  public ResponseEntity<Map<String, Integer>> deleteSlotsByDates(
      @RequestParam Long clinicId, @RequestBody List<String> dates) {
    try {
