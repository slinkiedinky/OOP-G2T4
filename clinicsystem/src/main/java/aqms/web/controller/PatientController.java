 ...
 * PatientController
 *
 * Patient-facing endpoints for viewing and booking appointments, viewing clinics and doctors,
 * and accessing appointment history.
 */
public class PatientController {
  ...
  public AppointmentSlot getScheduledAppointment(
      @PathVariable Long apptId, @RequestParam Long patientId) {
  ...
  public void cancelAppointment(@PathVariable Long apptId, @RequestParam Long patientId) {
  ...
  public boolean checkReschedule(@PathVariable Long apptId, @RequestParam Long patientId) {
