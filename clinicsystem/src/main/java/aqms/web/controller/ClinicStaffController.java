...
public class ClinicStaffController {
  ...
  public List<AppointmentSlot> getUpcomingAppointmentsByClinicName(
    ...
    Clinic clinic =
        clinicRepository.findAll().stream()
            ...
            .findFirst()
            .orElseThrow(
                () -> new IllegalArgumentException("Clinic not found with name: " + clinicName));
  ...
  public AppointmentSlot addTreatmentSummary(
      @PathVariable Long apptId, @RequestBody String treatmentSummary) {
  ...
  public AppointmentSlot markCompleted(
      @PathVariable Long apptId,
